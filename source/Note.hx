...
class Note extends FlxSprite
{
	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false)
	{
		...
		switch (PlayState.SONG.noteStyle)
		{
			...
			case 'blur':
				frames = Paths.getSparrowAtlas('notes/Blur_NOTE_assets');
			...
			case 'purple':
				frames = Paths.getSparrowAtlas('notes/Purple_NOTE_assets');
			...
			case 'halloween':
				frames = Paths.getSparrowAtlas('notes/Halloween_assets');
			...
			case 'dark':
				frames = Paths.getSparrowAtlas('notes/Dark_NOTE_assets');
			...
			case 'stepmania':
				frames = Paths.getSparrowAtlas('notes/Stepmania_assets');
