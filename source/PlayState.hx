...
class PlayState extends MusicBeatState
{
	...
	var secondary_bg:FlxSprite;
	var third_bg:FlxSprite;
	var sky:FlxSprite;
	var mountain:FlxSprite;
	var jungle:FlxSprite;
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'hinotori':
				dialogue = CoolUtil.coolTextFile(Paths.txt('hinotori/HinoDialogue'));
			case 'goodbye-declaration':
				dialogue = CoolUtil.coolTextFile(Paths.txt('goodbye-declaration/GoodDialogue'));
			case 'grim-reaper':
				dialogue = CoolUtil.coolTextFile(Paths.txt('grim-reaper/grimDialogue'));
			case 'envy-baby':
		...
		switch(SONG.stage)
		{
			...
			case 'cursednight':
			 ...
			 case 'bully':
			 {
						defaultCamZoom = 0.6;
						curStage = 'bully';
						var bg:FlxSprite = new FlxSprite(-800, -200).loadGraphic(Paths.image('stages/bully'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
			 ...
			 case 'tokyo':
			 {
						defaultCamZoom = 0.7;
						curStage = 'tokyo';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('stages/tokyo'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);			
			...
			case 'red-shift':
			 ...
			 case 'myth':
			 {
						defaultCamZoom = 0.6;
						curStage = 'myth';
						var bg:FlxSprite = new FlxSprite(-580, -200).loadGraphic(Paths.image('stages/myth'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);			
			 ...
			 case 'drowning':
			 {
						defaultCamZoom = 0.65;
						curStage = 'drowning';
						var bg:FlxSprite = new FlxSprite(-600, -180).loadGraphic(Paths.image('stages/drowning'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);	
						
						minecraft = new FlxSprite(-600, -180).loadGraphic(Paths.image('stages/minecraft'));
						minecraft.antialiasing = true;
						minecraft.scrollFactor.set(0.9, 0.9);
						minecraft.visible = false;
						add(minecraft); 

						mountain = new FlxSprite(-600, -180).loadGraphic(Paths.image('stages/mountain'));
						mountain.antialiasing = true;
						mountain.scrollFactor.set(0.9, 0.9);
						mountain.visible = false;
						add(mountain);

						jungle = new FlxSprite(-600, -180).loadGraphic(Paths.image('stages/jungle'));
						jungle.antialiasing = true;
						jungle.scrollFactor.set(0.9, 0.9);
			 ...
			 case 'rrat':
			 {
						defaultCamZoom = 0.9;
						curStage = 'rrat';
						var bg:FlxSprite = new FlxSprite(-100,10).loadGraphic(Paths.image('stages/happyRon_sky'));
						bg.updateHitbox();
						bg.scale.x = 1.2;
						bg.scale.y = 1.2;
						bg.active = false;
						...
						var ground:FlxSprite = new FlxSprite(-537, -250).loadGraphic(Paths.image('stages/happyRon_ground'));
						ground.updateHitbox();
						ground.active = false;
			...
			case 'spoopy':
				{
						defaultCamZoom = 1.5;
						curStage = 'spoopy';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('stages/stageback_spoopy'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
	
						var stageFront:FlxSprite = new FlxSprite(-650, 600).loadGraphic(Paths.image('stages/stagefront_spoopy'));
						stageFront.setGraphicSize(Std.int(stageFront.width * 1.1));
						stageFront.updateHitbox();
						stageFront.antialiasing = true;
						stageFront.scrollFactor.set(0.9, 0.9);
			...
			case 'void':
				{
						defaultCamZoom = 1.0;
						curStage = 'void';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('stages/void'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
			...
			case 'myth-trio':
				{
						...
						var Glitch:FlxSprite = new FlxSprite(-650, -400).loadGraphic(Paths.image('stages/Glitch'));
						...
						secondary_bg = new FlxSprite(-600, -180).loadGraphic(Paths.image('stages/inKnight'));
						secondary_bg.antialiasing = true;
						secondary_bg.setGraphicSize(Std.int(secondary_bg.width * 1.3));
						secondary_bg.scrollFactor.set(0.9, 0.9);
						secondary_bg.visible = false;						
						add(secondary_bg); 
		...
		switch (curStage)
		{
			...
			case 'livestage':
				...
				if (PlayState.SONG.song.toLowerCase()=='sorairo-days')
				{	
					boyfriend.x -= 550;
					boyfriend.y -= 90;
					dad.x -= 350;
			...
			case 'stage':
				{
					...
					dad.x -= 300;
					dad.y += 100;
					dad.setGraphicSize(Std.int(dad.width * 0.9));
					gf.visible = false;	
	...
	{
		case 'hinotori' | 'goodbye-declaration' | 'sparks': 
			healthBar.createFilledBar(0xFFff6600, 0xFF66FF33);					
			
		case 'grim-reaper' | 'envy-baby' | 'cursed-night':
			healthBar.createFilledBar(0xFFf556ba, 0xFF66FF33);

		case 'vampire' | 'red-shift': 
			healthBar.createFilledBar(0xFFff6600, 0xFF0C94F5);	

		case 'red-shift-ex':
			healthBar.createFilledBar(0xFFff6600, 0xFFD55F56);

		case 'the-bully' | 'end-of-a-life' | 'red':
			healthBar.createFilledBar(0xFFf556ba, 0xFFa222b3);

		case 'live-again':
			healthBar.createFilledBar(0xFFf556ba, 0xFFff6600);	

		case 'sorairo-days':
			healthBar.createFilledBar(0xFFff6600, 0xFFf556ba);	
			
		case 'myth-or-treat':
			healthBar.createFilledBar(0xFF7b18de, 0xFF414345);	
			
		case 'mining':
			healthBar.createFilledBar(0xFFebe010, 0xFF66FF33);	
		...
		kadeEngineWatermark = new FlxText(4,healthBarBG.y + 50,0,SONG.song + " " + (storyDifficulty == 2 ? "Hard" : storyDifficulty == 1 ? "Hard" : "Easy") + (Main.watermarks ? " - KE " + MainMenuState.kadeEngineVer : ""), 16);
	...
	private function generateStaticArrows(player:Int):Void
	{
		for (i in 0...4)
		{
			...
			switch (SONG.noteStyle)
			{
				...
				case 'blur':
					babyArrow.frames = Paths.getSparrowAtlas('notes/Blur_NOTE_assets');
				...
				case 'purple':
					babyArrow.frames = Paths.getSparrowAtlas('notes/Purple_NOTE_assets');
					babyArrow.animation.addByPrefix('green', 'arrowUP');
					babyArrow.animation.addByPrefix('blue', 'arrowDOWN');
					babyArrow.animation.addByPrefix('purple', 'arrowLEFT');
					babyArrow.animation.addByPrefix('red', 'arrowRIGHT');
				...
				case 'halloween':
					babyArrow.frames = Paths.getSparrowAtlas('notes/Halloween_assets');
					babyArrow.animation.addByPrefix('green', 'arrowUP');
					babyArrow.animation.addByPrefix('blue', 'arrowDOWN');
					babyArrow.animation.addByPrefix('purple', 'arrowLEFT');
					babyArrow.animation.addByPrefix('red', 'arrowRIGHT');
				...
				case 'dark':
					babyArrow.frames = Paths.getSparrowAtlas('notes/Dark_NOTE_assets');
					babyArrow.animation.addByPrefix('green', 'arrowUP');
					babyArrow.animation.addByPrefix('blue', 'arrowDOWN');
					babyArrow.animation.addByPrefix('purple', 'arrowLEFT');
					babyArrow.animation.addByPrefix('red', 'arrowRIGHT');
				...
				case 'stepmania':
					babyArrow.frames = Paths.getSparrowAtlas('notes/Stepmania_assets');
					babyArrow.animation.addByPrefix('green', 'arrowUP');
					babyArrow.animation.addByPrefix('blue', 'arrowDOWN');
					babyArrow.animation.addByPrefix('purple', 'arrowLEFT');
					babyArrow.animation.addByPrefix('red', 'arrowRIGHT');
	...
	*/
	...
	override function stepHit()
	{
		...
		if (curSong == 'monocalli')
		{
			switch(curStep)
						{
							case 503, 963, 951, 971, 979, 1115, 1207, 1535:
								ShakeCam = true;
								Flash = true;

							case 504, 964, 952, 972, 980, 1116, 1208, 1536:
								ShakeCam = false;
								Flash = false;
						}
				
		}
		if (curSong == 'myth-trouble')
		{
			switch(curStep)
						{
							case 1038,1294,2318,2821,4109:
								Flash = true;
							case 1039,1295,2319,2822,4110:
								Flash = false;

							case 1040:  // First Sonic
								secondary_bg.visible = true;
							
							case 1296:  // Knuckles
								secondary_bg.visible = false;

							case 2320: // Second sonic
								secondary_bg.visible = true;

							case 2823: // Eggman
								secondary_bg.visible = false;
							
							case 4111: // Third Sonic
								secondary_bg.visible = true;
